...
<div id="body" class="font-container px-4 sm:px-10 lg:px-20 bg-scroll">
  ...
  <span class="actual-text">&nbsp;Indranil&nbsp;</span>
  <span class="hover-text1" aria-hidden="true">&nbsp;Indranil&nbsp;</span>
</button>
<button data-text="Awesome" class="button2 dark:hidden block">
  <span class="actual-text">&nbsp;Indranil&nbsp;</span>
  <span class="hover-text2" aria-hidden="true">&nbsp;Indranil&nbsp;</span>
</button>
    ...
    <div id="hero" class="mt-20 mb-20 ">
      <div class=""><!-- commented text-center for having the text at left instead of center-->
        <h1 class="text-gray-950 dark:text-gray-100 text-3xl md:text-5xl font-bold mb-2 tracking-tight">Indranil Samanta</h1>
        <div id="typed-strings">
          <p class="text-gray-600 dark:text-gray-400 text-1xl md:text-2xl max-w-screen-md mx-auto font-normal tracking-tight mb-4">Student • Web Developer • AI Enthusiast  • Problem Solver</p>
        </div>
      ...
      <div class=""><!-- commented text-center for having the text at left instead of center-->
        ...
        <div class="mt-8 flex flex-wrap gap-5  mb-16"><!-- commented justify-center for having the text at left instead of center-->
          <a href="https://github.com/Indranil102" aria-label="GitHub" class="dark:fill-white fill-black transition-transform hover:scale-150">
          ...
          <a href="https://www.linkedin.com/in/indranil-samanta-26558a253?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" aria-label="LinkedIn" class="dark:fill-white  transition-transform hover:scale-150 fill-black">
            <svg width="30" height="30" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
          ...
          <a href="https://www.instagram.com/eeindu.10/profilecard/?igsh=ZDgxNDhvY29ydW4z" aria-label="Instagram" class="dark:fill-white transition-transform  fill-black hover:scale-150">
          ...
          <a href="https://x.com/Tiku2710?t=0kNjKK5lG_DFlG_KVxHHXw&s=09" aria-label="Twitter" class="dark:fill-white transition-transform  fill-black hover:scale-150">
            <svg width="30" height="30" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
      ...
      <div id="projects">
        ...
        <div id="cards" class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 px-4 sm:px-10 lg:px-20">
          <div id="block" class="mt-8 shadow-md dark:bg-zinc-900 bg-zinc-100 rounded-xl border-2 border-solid border-zinc-400 dark:border-zinc-700 hover:border-zinc-600 dark:hover:border-white  transform hover:scale-103 transition-transform">
            ...
            Create a React.js eCommerce site with pages for clothing, cart, checkout, and profile. Ensure responsiveness and smooth navigation.
              ...
              <a href="https://github.com/Indranil102/Shopping.git" class="bg-gray-900  items-center hover:scale-110 transition-transform transform dark:bg-gray-100 text-white dark:text-black flex gap-2 p-3 rounded-md font-medium ml-5">Github
        ...
        <button id="a" class="mt-8 mb-16 flex  px-4 sm:px-10 lg:px-20 transition-transform hover:scale-105 "><!-- commented justify-center for having the text at left instead of center-->
          <p class="dark:text-gray-900 flex gap-2 text-2xl font-md dark:bg-gray-100 p-3 rounded-lg text-gray-100 bg-gray-900 tracking-tight">
            <a class="flex gap-2" href="https://github.com/Indranil102">View more projects
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
            ...
            <div id="block" class="mt-8 p-4 grid col-span-1 shadow-md w-full dark:bg-zinc-900 bg-zinc-100 rounded-xl border-2 border-solid border-zinc-400 dark:border-zinc-700 hover:border-zinc-600 dark:hover:border-white transform hover:scale-105 transition-transform">
                ...
                <div class="flex flex-wrap gap-3 px-2 sm:px-5 pt-3 sm:pt-6">
                    ...
                    <img class="w-8 h-8 sm:w-16 sm:h-16 mb-5" src="https://skillicons.dev/icons?i=nodejs" alt="Nodejs">
            ...
            <h1 class=" dark:text-gray-100 text-2xl m-3 sm:text-4xl font-bold tracking-tight mb-4">Database and Tools</h1>
                ...
                <div class="flex flex-wrap gap-3 px-2 sm:px-5 pt-3 sm:pt-6">
                    ...
                    <img class="w-8 h-8 sm:w-16 sm:h-16 mb-5" src="  https://skillicons.dev/icons?i=firebase" alt="Firebase">
  ...
  <div id="block" class="flex justify-center items-center">
    ...
    <div class="md:w-full bg-zinc-200 dark:bg-zinc-800 text-gray-900 dark:text-gray-100 p-8 rounded-lg">
      ...
      <div class="flex items-center mb-4">
        ...
        <span>indranilsamanta2003@gmail.com</span>
      </div>
    ...
    <button class="cursor-pointer group relative flex gap-1.5 px-8 py-4 bg-black bg-opacity-80 text-[#f1f1f1] rounded-lg hover:bg-opacity-70 transition font-semibold shadow-md">
        ...
        </svg><a href="https://drive.google.com/file/d/1s-Ff-fRrmpsNLcEE_EubIaUdJaMcuoAb/view?usp=drive_link">
        Resume</a>
        <div class="absolute opacity-0 -bottom-full rounded-md py-2 px-2 bg-black bg-opacity-70 left-1/2 -translate-x-1/2 group-hover:opacity-100 transition-opacity shadow-lg">
          <a href="https://drive.google.com/file/d/1s-Ff-fRrmpsNLcEE_EubIaUdJaMcuoAb/view?usp=drive_link">Resume</a>
        </div>
      </button>
